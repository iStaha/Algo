...
public class COLLEECORS {
	...
	public static void main(String[] args) {
		 ...
		 * 
		 * collect() method is a terminal operation in Stream interface. It is a special
		 * case of reduction operation called mutable reduction operation because it
		 * returns mutable result container such as List, Set or Map according to
		 * supplied Collector.
		 */
	...
	public static void ColllecttoCollection() {
